...
export const metadata: Metadata = {
  title: "F1 Racing - New Generation Formula 1 Models | Championship Technology",
  description: "Discover our 2024 Formula 1 model range featuring cutting-edge aerodynamics, hybrid power units, and championship-winning technology. Built for racing excellence.",
  keywords: "Formula 1, F1 models, racing cars, motorsport, aerodynamics, hybrid power, championship, racing technology",
  metadataBase: new URL("https://f1racing.com"),
  alternates: {
    canonical: "https://f1racing.com"
  },
  openGraph: {
    title: "F1 Racing - New Generation Formula 1 Models",
    description: "Experience the pinnacle of motorsport engineering with our championship-winning Formula 1 car models.",
    url: "https://f1racing.com",
    siteName: "F1 Racing",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763655636354-eb0dw86e.jpg",
      alt: "F1 Racing championship car"
    }],
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "F1 Racing - Championship Formula 1 Models",
    description: "Discover our 2024 F1 model range with revolutionary racing technology",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763655636354-eb0dw86e.jpg"]
  },
  robots: {
    index: true,
    follow: true
